...
class ScheduleContent extends GetView<OnPlanController> {
...
class ScheduleWidget extends GetView<OnPlanController> {
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return index != controller.tasks.length
                        ? buildTimelineItem(
                            ...
                            isActive:
                                controller.currentTaskIndex.value == index,
                            location: currentTask.planLocation,
                          ).onTap(() {
                            controller.onTapTask(currentTask);
                          })
                        : SizedBox(height: 64);
                  },
                ),
